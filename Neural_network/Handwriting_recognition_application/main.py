...
# - network.py example:
import network
net = network.CustomNetwork([784, 30, 10])

if input("command>>") == "load_data":
    net.SGD(training_data)
if input("command>>") == "upload_one_sample":
    net.upload_one_sample()
if input("command>>") == "feed_one_sample":
    net.feed_one_sample(0.3)
...
"""
    ...
    3) should work, run it with:
        THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python3.5 main.py
